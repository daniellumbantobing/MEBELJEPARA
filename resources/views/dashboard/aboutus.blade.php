...
<div class="about">
    <div class="col-md-12">
         <div class="card" style="background-color: #F5F5FA; border-radius:20px">
  <div class="card-body">
...
<div class="container mt-4">
    <h5>Tentang Stasiun Mebel Jepara</h5><br>
    ...
    <p>Stasiun Mebel Jepara adalah toko sekaligus produsen produk-produk indoor mebel jati yang berkualitas 
       ...
       <p> Stasiun Mebel Jepara memberikan jaminan kualitas produk mebel Jepara dan melayani segala macam 
           pesanan mebel jati untuk perkantoran, perumahan, apartemen serta hotel. Stasiun Mebel Jepara juga
            menyediakan mulai dari set meja makan, dapur, kursi tamu, sofa, tempat tidur, lemari, bufet, 
            meja rias, mulai dari motif ukir sampai minimalis. </p>
        <br>

    <h5>Mengapa harus di Stasiun Mebel Jepara?</h5><br>
        <p>
